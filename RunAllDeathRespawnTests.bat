...
set "REPORT_DIR=%PROJECT_ROOT%Saved\AutomationReports\DeathRespawn"
...
echo Running all ChallengeGame death and respawn automation tests...
call "%EDITOR_CMD%" "%PROJECT_FILE%" -unattended -nop4 -nosplash -NullRHI -ExecCmds="Automation RunTest ChallengeGame.DeathRespawn.RespawnState;Quit" -ReportExportPath="%REPORT_DIR%"
set "EXIT_CODE=%ERRORLEVEL%"
echo.
echo Test run finished.
echo Report directory: %REPORT_DIR%
echo Expected baseline: DR-09 fails to document DEF-001.
